...
public class Main extends Application {
  ...
  public static final int TEMPERATURE_CALLBACK_PERIOD = 5_000;
  ...
  public static final int ILLUMINANCE_CALLBACK_PERIOD = 5_000;
...
//    primaryStage.setFullScreen(true);
  ...
  private final static Character c0 = (char) 0;
  private final static Character c1 = (char) 1;
  private final static Character c2 = (char) 2;
  private final static Character c3 = (char) 3;
  private final static Character c4 = (char) 4;
  private final static Character c5 = (char) 5;
  private final static Character c6 = (char) 6;
  private final static Character c7 = (char) 7;
  private final static Character c8 = (char) 8;
  private final static Character c9 = (char) 9;
  ...
  private void setTheSegments(SevenSegment[] sevenSegmentsLine, int i) {
    ...
    for (final int aChar : charArray) {
      ...
      //sevenSegment.setCharacter(aChar); //implizit bei int ein Integer.toString ->
...
//      }
      // viele GC logs-----
      if(aChar == 0)      { sevenSegment.setCharacter(c0);}
      else if(aChar == 1) { sevenSegment.setCharacter(c1);}
      else if(aChar == 2) { sevenSegment.setCharacter(c2);}
      else if(aChar == 3) { sevenSegment.setCharacter(c3);}
      else if(aChar == 4) { sevenSegment.setCharacter(c4);}
      else if(aChar == 5) { sevenSegment.setCharacter(c5);}
      else if(aChar == 6) { sevenSegment.setCharacter(c6);}
      else if(aChar == 7) { sevenSegment.setCharacter(c7);}
      else if(aChar == 8) { sevenSegment.setCharacter(c8);}
      else if(aChar == 9) { sevenSegment.setCharacter(c9);}
...
//  }
  ...
  public static class SevenSegmentIOT extends SevenSegment{
